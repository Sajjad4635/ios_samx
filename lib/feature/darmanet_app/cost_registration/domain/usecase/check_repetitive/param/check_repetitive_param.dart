...
part 'check_repetitive_param.g.dart';

@JsonSerializable(createFactory: false)
class CheckRepetitiveParam extends Equatable {
  @JsonKey(name: "Id")
  final String id;
  ...
  Map<String, dynamic> toJson() => _$CheckRepetitiveParamToJson(this);
