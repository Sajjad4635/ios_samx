...
class WithdrawFinalRequestDetail extends StatelessWidget {
  const WithdrawFinalRequestDetail({
    super.key,
              ...
              child: Row(
                ...
                children: [
                  Row(
                    children: [
                      Icon(
                        Magicon.moneyBillSend,
                        size: 20,
                        color: colorTheme.solidVariant,
                      ),
                      const SizedBox(width: 8),
                      Text(
                        'cplife.collect_deposit'.tr(),
                  ...
                  RichText(
                    text: TextSpan(
                      children: <TextSpan>[
                        TextSpan(
                          text: withdrawAmount.toPersianDigit().seRagham(),
