...
void main() async {
  ...
  FlavorConfig(
    ...
    variables: {
      "baseURL": dotenv.env["STG_BASE_URL"]!,
      "cpLifeURL": dotenv.env["STG_CPLIFE_URL"]!,
      "darmanetURL": dotenv.env["STG_DARMANET_URL"]!,
      "supportOtrsURL": dotenv.env["STG_SUPPORT_OTRS_URL"]!,
      "darmanetSupportUrl": dotenv.env["DARMANET_SUPPORT_URL"]!,
      "minioUrl": dotenv.env["STG_MINIO_URL"]!,
      "walletUrl": dotenv.env["STG_WALLET_URL"]!,
      "unitLinkUrl": dotenv.env["STG_UNITLINKED_URL"]!,
      "samxUrl": dotenv.env["STG_SAMX_URL"]!,
      "version": dotenv.env["STG_VERSION"]!,
      "redirectURL": dotenv.env["STG_REDIRECT_URL"]!,
