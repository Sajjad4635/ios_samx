...
void main() async {
  ...
  FlavorConfig(
    ...
    variables: {
      "baseURL": dotenv.env["BTA_BASE_URL"]!,
      "cpLifeURL": dotenv.env["BTA_CPLIFE_URL"]!,
      "darmanetURL": dotenv.env["BTA_DARMANET_URL"]!,
      "supportOtrsURL": dotenv.env["BTA_SUPPORT_OTRS_URL"]!,
      "darmanetSupportUrl": dotenv.env["DARMANET_SUPPORT_URL"]!,
      "minioUrl": dotenv.env["BTA_MINIO_URL"]!,
      "walletUrl": dotenv.env["BTA_WALLET_URL"]!,
      "unitLinkUrl": dotenv.env["BTA_UNITLINKED_URL"]!,
      "samxUrl": dotenv.env["BTA_SAMX_URL"]!,
      "version": dotenv.env["BTA_VERSION"]!,
      "redirectURL": dotenv.env["BTA_REDIRECT_URL"]!,
